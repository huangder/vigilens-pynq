...
> 两者**是同一颗器件**（`XC7Z020-1CLG400C` ≡ Vivado 的 `xc7z020clg400-1`），所以四个 HLS IP 与黄金参考**无需重做**；
...
| 里程碑 | 内容 | 状态 |
|---|---|---|
| **M0** 冻结 | 主场景 / 项目名 / 指标范围 / 接口契约 / 目录结构 / 仓库与协议 | ✅ **完成**（`docs/00`、`docs/interface.md` 🔒 **v1.1 已会签完成**、仓库 `vigilens-pynq`、MIT） |
