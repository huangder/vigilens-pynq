...
|---|---|---|---|---|---|
| `roi_statistic` | 1269 | 723 | 0 | 1 | 138.99 MHz |
| `rgb2gray` v2 | 1412 | 918 | 0 | 5 | 137.46 MHz |
| `motion_quality` v2 | 1501 | 1158 | 64 | 1 | 140.05 MHz |
| `fir_filter` v1 | 4077 | 6172 | 0 | 25 | 146.97 MHz |
| **合计** | **8259（15.5%）** | **8971（8.4%）** | **64（23%）** | **32（14.5%）** | 全部 **> 137 MHz** |

来源：各 `component_<ip>/hls/syn/report/csynth.rpt`；汇总见 `fpga/README.md` 的 IP 汇总表。
`fir_filter` 的 DSP 25 是"全并行 + II=1"的代价，**可调**（见第 6 节降级路径）。
